      ...
      <table role="presentation" width="560" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:14px;overflow:hidden">
        ...
        <tr>
          <td style="padding:28px;color:#16181d;font-size:14px;line-height:1.6">
            ...
            <p style="margin:0 0 14px">Agradecemos o seu interesse. No momento não podemos seguir com a sua solicitação de abertura de conta.</p>
            <p style="margin:0 0 14px">Você poderá tentar novamente em <strong>3 meses</strong>.</p>
